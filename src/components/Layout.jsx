...
function Sidebar({ open, onClose, schoolId, setSchool, navigate, schools }) {
  return (
    <>
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <Sidebar open={open} onClose={() => setOpen(false)} schoolId={schoolId} setSchool={setSchool} navigate={navigate} schools={schools} />
